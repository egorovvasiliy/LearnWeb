declare interface ClassMenu {
    WrapMenu, wrapItem0, wrapItem1, wrapItem2, closerMenu, CurrentMenu, LeftMenu, RightMenu, ShowBorderRightMenu, itemImage, CenterContent, itemName0, itemName1: string
}
declare interface ClassTable {
    TabPoints, TitleTab,CloseTab: string
}
declare interface ClassMap {
...
declare interface ClassChatWindow {
    Logout, Login, Status, BorderBottom,WindowMessages:string
}